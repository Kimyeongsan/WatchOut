...
public class GuardianManagement {
    private static GuardianManagement mData = new GuardianManagement();
    private GuardianData guardianData;                  // 유저 정보

    private GuardianManagement() {
        guardianData = null;
    }

    public static GuardianManagement getInstance() {
        return mData;
    }
    ...
    public static void registerUser(final FirebaseUser user) {
        GuardianManagement mData;   // 싱글톤 객체(앱상에서 전반적인 데이터 관리)
